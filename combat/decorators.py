...
def _add_span_attributes(span, func, args, kwargs, entity_type: str):
...
def _add_output_attributes(span, result: Any):
...
def workflow(target: Union[F, C, None] = None, *, name: Optional[str] = None) -> Union[F, C, Callable[[Union[F, C]], Union[F, C]]]:
    ...
    def decorator(obj: Union[F, C]) -> Union[F, C]:
        if inspect.isclass(obj):
            return _wrap_class_methods(obj, "workflow", name)
        else:
            return _create_function_wrapper(obj, "workflow", name)
...
def agent(target: Union[F, C, None] = None, *, name: Optional[str] = None) -> Union[F, C, Callable[[Union[F, C]], Union[F, C]]]:
    ...
    def decorator(obj: Union[F, C]) -> Union[F, C]:
        if inspect.isclass(obj):
            return _wrap_class_methods(obj, "agent", name)
        else:
            return _create_function_wrapper(obj, "agent", name)
...
def task(target: Union[F, C, None] = None, *, name: Optional[str] = None) -> Union[F, C, Callable[[Union[F, C]], Union[F, C]]]:
    ...
    def decorator(obj: Union[F, C]) -> Union[F, C]:
        if inspect.isclass(obj):
            return _wrap_class_methods(obj, "task", name)
        else:
            return _create_function_wrapper(obj, "task", name)
