...
class SessionManager:
    ...
    def set_input(cls, value: Any) -> None:
        ...
        try:
            ...
            cls.set_attribute_on_active_span("netra.input", serialized)
        except Exception:
    ...
    def set_output(cls, value: Any) -> None:
        ...
        try:
            if isinstance(value, (dict, list)):
                ...
                serialized = str(value)[: Config.ATTRIBUTE_MAX_LEN]
            cls.set_attribute_on_active_span("netra.output", serialized)
        except Exception:
    ...
    def set_root_input(cls, value: Any) -> None:
        ...
        try:
            if isinstance(value, (dict, list)):
                ...
                serialized = str(value)[: Config.ATTRIBUTE_MAX_LEN]
            cls.set_attribute_on_root_span("netra.input", serialized)
        except Exception:
    ...
    def set_root_output(cls, value: Any) -> None:
        ...
        try:
            if isinstance(value, (dict, list)):
                ...
                serialized = str(value)[: Config.ATTRIBUTE_MAX_LEN]
            cls.set_attribute_on_root_span("netra.output", serialized)
        except Exception:
