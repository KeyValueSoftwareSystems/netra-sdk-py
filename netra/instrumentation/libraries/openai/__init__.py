...
from netra.instrumentation.libraries.openai.version import __version__
from netra.instrumentation.libraries.openai.wrappers import (
    achat_wrapper,
    aembeddings_wrapper,
    aresponses_wrapper,
    chat_wrapper,
...
_TRACER_NAME = "netra.instrumentation.openai"
