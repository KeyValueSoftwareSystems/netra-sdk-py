...
from netra.instrumentation.libraries.groq.version import __version__
from netra.instrumentation.libraries.groq.wrappers import (
    achat_wrapper,
    chat_wrapper,
)
...
_TRACER_NAME = "netra.instrumentation.groq"
