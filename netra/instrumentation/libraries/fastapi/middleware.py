    ...
    async def _handle_request(
        ...
        with self.tracer.start_as_current_span(
            ...
            try:
                ...
                logger.debug("netra.instrumentation.libraries.fastapi: failed to set span input: %s", e)
            ...
            if response_status_code:
                ...
                try:
                    ...
                    logger.debug("netra.instrumentation.libraries.fastapi: failed to set span output: %s", e)
