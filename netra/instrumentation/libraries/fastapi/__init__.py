...
from netra.instrumentation.libraries.fastapi.middleware import NetraFastAPIMiddleware
...
_TRACER_NAME = "netra.instrumentation.fastapi"
...
class NetraFastAPIInstrumentor(BaseInstrumentor):  # type: ignore[misc]
    ...
    def instrument_app(
        ...
        :class:`~netra.instrumentation.libraries.fastapi.middleware.NetraFastAPIMiddleware`
