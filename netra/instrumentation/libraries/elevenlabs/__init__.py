...
from netra.instrumentation.libraries.elevenlabs.version import __version__
from netra.instrumentation.libraries.elevenlabs.wrappers import (
...
_TRACER_NAME = "netra.instrumentation.elevenlabs"
