...
from netra.instrumentation.libraries.dspy.version import __version__
from netra.instrumentation.libraries.dspy.wrappers import (
...
_TRACER_NAME = "netra.instrumentation.dspy"
