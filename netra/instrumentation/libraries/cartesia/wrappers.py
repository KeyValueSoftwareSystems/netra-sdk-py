...
from netra.instrumentation.libraries.cartesia.utils import (
    ...
    def wrapper(wrapped: Callable[..., Any], instance: Any, args: Tuple[Any, ...], kwargs: Dict[str, Any]) -> Any:
        ...
        with tracer.start_as_current_span(span_name, kind=SpanKind.CLIENT) as span:
            try:
                ...
                logger.error("netra.instrumentation.libraries.cartesia: %s", e)
                raise
...
def _wrap_tts_ws(tracer: Tracer, span_name: str) -> Callable[..., Any]:
    ...
    def wrapper(wrapped: Callable[..., Any], instance: Any, args: Tuple[Any, ...], kwargs: Dict[str, Any]) -> Any:
        ...
        try:
            ...
            logger.error("netra.instrumentation.libraries.cartesia.tts.websocket: %s", e)
            span.end()
            raise
        finally:
...
def _wrap_stt_ws(tracer: Tracer, span_name: str) -> Callable[..., Any]:
    ...
    def wrapper(wrapped: Callable[..., Any], instance: Any, args: Tuple[Any, ...], kwargs: Dict[str, Any]) -> Any:
        ...
        try:
            ...
            logger.error("netra.instrumentation.libraries.cartesia.stt.websocket: %s", e)
            span.end()
            raise
        finally:
            context_api.detach(context)
