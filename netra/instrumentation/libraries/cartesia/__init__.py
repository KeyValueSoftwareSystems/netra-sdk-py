...
from netra.instrumentation.libraries.cartesia.version import __version__
from netra.instrumentation.libraries.cartesia.wrappers import (
    stt_wrapper,
    stt_ws_wrapper,
    tts_bytes_wrapper,
    tts_ws_wrapper,
...
_TRACER_NAME = "netra.instrumentation.cartesia"
