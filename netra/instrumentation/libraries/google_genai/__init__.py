...
from netra.instrumentation.libraries.google_genai.version import __version__
from netra.instrumentation.libraries.google_genai.wrappers import (
...
_TRACER_NAME = "netra.instrumentation.google_genai"
