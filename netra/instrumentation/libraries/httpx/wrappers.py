...
class _BaseStreamingWrapper(ObjectProxy):  # type: ignore[misc]
    ...
    def _finalize_span(self) -> None:
        ...
        try:
            ...
            logger.debug("netra.instrumentation.libraries.httpx: failed to finalize streaming span: %s", e)
        finally:
            self._span.end()
...
def send_wrapper(tracer: Tracer) -> Callable[..., Any]:
    ...
    def wrapper(wrapped: Callable[..., Any], instance: Any, args: Tuple[Any, ...], kwargs: Dict[str, Any]) -> Any:
        ...
        try:
            ...
            logger.debug("netra.instrumentation.libraries.httpx: failed to extract request metadata: %s", e)
            return wrapped(*args, **kwargs)
        ...
        if not is_streaming:
            with tracer.start_as_current_span(
                ...
                try:
                    ...
                    logger.error("netra.instrumentation.libraries.httpx: %s", e)
                ...
                try:
                    ...
                    logger.debug("netra.instrumentation.libraries.httpx: failed to process response span: %s", e)
        ...
        try:
            ...
            try:
                ...
                logger.debug("netra.instrumentation.libraries.httpx: failed to set response status on span: %s", e)
