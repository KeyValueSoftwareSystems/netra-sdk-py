...
:class:`~netra.instrumentation.libraries.livekit.audio_sender.AudioChunkSender`. It owns
two things:

* **where a frame belongs** — the ``user_speaking``/``agent_speaking`` span open
  at the moment of capture, pushed in by
  :class:`~netra.instrumentation.libraries.livekit.audio_processor.AudioSpanProcessor`.
...
from netra.instrumentation.libraries.livekit.audio_sender import (
