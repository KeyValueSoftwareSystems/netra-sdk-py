...
from netra.instrumentation.libraries.cerebras.version import __version__
from netra.instrumentation.libraries.cerebras.wrappers import (
    achat_wrapper,
...
_TRACER_NAME = "netra.instrumentation.cerebras"
...
class NetraCerebrasInstrumentor(BaseInstrumentor):  # type:ignore[misc]
    ...
    def _instrument(self, **kwargs: Any) -> None:
        tracer = get_tracer(_TRACER_NAME, __version__, kwargs.get("tracer_provider"))
