...
from netra.instrumentation.libraries.honcho.version import __version__
from netra.instrumentation.libraries.honcho.wrappers import (
    make_async_wrapper,
...
_TRACER_NAME = "netra.instrumentation.honcho"
