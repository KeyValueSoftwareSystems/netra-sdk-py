...
from netra.instrumentation.libraries.pydantic_ai.version import __version__
from netra.instrumentation.libraries.pydantic_ai.wrappers import (
    agent_iter_wrapper,
...
_TRACER_NAME = "netra.instrumentation.pydantic_ai_slim"
