...
from netra.instrumentation.libraries.agno.utils import (
...
def _start_span(
    ...
    try:
        ...
        logger.error("netra.instrumentation.libraries.agno: failed to start span for %s: %s", span_name, e)
        return None, None
    try:
        ctx_token = context_api.attach(set_span_in_context(span))
        return span, ctx_token
    except Exception as e:
        logger.error("netra.instrumentation.libraries.agno: failed to attach context for %s: %s", span_name, e)
        try:
            span.end()
        except Exception as e:
            logger.debug(
                "netra.instrumentation.libraries.agno: failed to end span during context attach cleanup: %s", e
            )
        return None, None
...
def _close_span(span: Span, ctx_token: Any, error: Optional[Exception] = None) -> None:
    ...
    try:
        ...
        logger.error("netra.instrumentation.libraries.agno: failed to set span status: %s", e)
    try:
        if ctx_token is not None:
            context_api.detach(ctx_token)
    except Exception as e:
        logger.debug("netra.instrumentation.libraries.agno: failed to detach context: %s", e)
    try:
        span.end()
    except Exception as e:
        logger.error("netra.instrumentation.libraries.agno: failed to end span: %s", e)
...
class _BaseStreamWrapper:
    ...
    def _finalize(self, error: Optional[Exception] = None) -> None:
        ...
        if error is None:
            try:
                ...
                logger.warning("netra.instrumentation.libraries.agno: failed to set output attrs on stream end: %s", e)
    ...
    def __del__(self) -> None:
        ...
        try:
            ...
            logger.debug("netra.instrumentation.libraries.agno: error finalizing stream: %s", e)
    ...
    def _set_output_on_success(self) -> None:
        ...
        if self._content_chunks:
            ...
            try:
                ...
                logger.debug(
                    "netra.instrumentation.libraries.agno: failed to serialize tool_calls for LLM output: %s", e
                )
    ...
    def __enter__(self) -> "SpanStreamingWrapper":
        ...
        if hasattr(self._response, "__enter__"):
            try:
                ...
                logger.debug("netra.instrumentation.libraries.agno: error in stream __enter__: %s", e)
        return self
    ...
    def __exit__(self, exc_type: Any, exc_val: Any, exc_tb: Any) -> None:
        ...
        if hasattr(self._response, "__exit__"):
            try:
                ...
                logger.debug("netra.instrumentation.libraries.agno: error in stream __exit__: %s", e)
    ...
    def __next__(self) -> Any:
        ...
        try:
            ...
            try:
                ...
                logger.debug("netra.instrumentation.libraries.agno: failed to accumulate stream content: %s", e)
            return event
    ...
    async def __aenter__(self) -> "AsyncSpanStreamingWrapper":
        ...
        if hasattr(self._response, "__aenter__"):
            try:
                ...
                logger.debug("netra.instrumentation.libraries.agno: error in async stream __aenter__: %s", e)
        return self
    ...
    async def __aexit__(self, exc_type: Any, exc_val: Any, exc_tb: Any) -> None:
        ...
        if hasattr(self._response, "__aexit__"):
            try:
                ...
                logger.debug("netra.instrumentation.libraries.agno: error in async stream __aexit__: %s", e)
        self._finalize(error=exc_val if exc_type is not None else None)
    ...
    async def __anext__(self) -> Any:
        ...
        try:
            ...
            try:
                ...
                logger.debug("netra.instrumentation.libraries.agno: failed to accumulate async stream content: %s", e)
            return event
    ...
    def __next__(self) -> Any:
        ...
        try:
            ...
            try:
                ...
                logger.debug("netra.instrumentation.libraries.agno: failed to accumulate llm stream content: %s", e)
            return chunk
        except StopIteration:
            self._finalize()
            raise
    ...
    async def __anext__(self) -> Any:
        ...
        try:
            ...
            try:
                ...
                logger.debug(
                    "netra.instrumentation.libraries.agno: failed to accumulate async llm stream content: %s", e
                )
            return chunk
        except StopAsyncIteration:
            self._finalize()
...
def _sync_non_stream(
    ...
    try:
        ...
        logger.warning(
            "netra.instrumentation.libraries.agno: failed to set request attributes for %s: %s", span_name, e
        )
    ...
    try:
        ...
        try:
            ...
            logger.warning(
                "netra.instrumentation.libraries.agno: failed to set response attributes for %s: %s", span_name, e
            )
        return response
    except Exception as e:
        try:
            ...
            logger.error("netra.instrumentation.libraries.agno: failed to record error for %s: %s", span_name, span_err)
        raise
    finally:
        try:
            if ctx_token is not None:
            ...
            logger.error("netra.instrumentation.libraries.agno: failed to end span for %s: %s", span_name, e)
...
def _sync_stream_start(
    ...
    try:
        ...
        try:
            ...
            logger.error(
                "netra.instrumentation.libraries.agno: failed to finalize span on %s error: %s", span_name, span_err
            )
        raise
...
def _set_tool_span_attrs(
    ...
    try:
        ...
        logger.warning(
            "netra.instrumentation.libraries.agno: failed to set request attributes for %s: %s", tool_name, e
        )
    try:
        ...
        logger.warning("netra.instrumentation.libraries.agno: failed to set tool arguments for %s: %s", tool_name, e)
    ...
    def wrapper(
        ...
        try:
            ...
            try:
                ...
                logger.warning(
                    "netra.instrumentation.libraries.agno: failed to set response attributes for %s: %s", tool_name, e
                )
            return response
        except Exception as e:
            try:
                ...
                logger.error(
                    "netra.instrumentation.libraries.agno: failed to record error for %s: %s", tool_name, span_err
                )
            raise
        finally:
            try:
                ...
                logger.error("netra.instrumentation.libraries.agno: failed to end span for %s: %s", tool_name, e)
        ...
        def wrapper(
            ...
            try:
                ...
                try:
                    ...
                    logger.warning(
                        "netra.instrumentation.libraries.agno: failed to set response attributes for %s: %s",
                        span_name,
                        e,
                    )
                return response
                ...
                try:
                    ...
                    logger.error(
                        "netra.instrumentation.libraries.agno: failed to record error for %s: %s", span_name, span_err
                    )
                raise
            finally:
                try:
...
def _start_llm_span(tracer: Tracer, instance: Any) -> Optional[Span]:
    ...
    try:
        ...
        logger.error("netra.instrumentation.libraries.agno: failed to start LLM span: %s", e)
        return None
...
def _setup_llm_span_with_input(
    ...
    try:
        ...
        logger.error("netra.instrumentation.libraries.agno: failed to attach LLM span context: %s", e)
    ...
    def wrapper(
        ...
        try:
            ...
            try:
                ...
                logger.warning("netra.instrumentation.libraries.agno: failed to set LLM response attributes: %s", e)
            return response
        except Exception as e:
            try:
                span.set_status(Status(StatusCode.ERROR, str(e)))
                ...
                logger.error("netra.instrumentation.libraries.agno: failed to record error on LLM span: %s", span_err)
            raise
        finally:
            try:
                if ctx_token is not None:
                ...
                logger.error("netra.instrumentation.libraries.agno: failed to end LLM span: %s", e)
    ...
    def wrapper(
        ...
        try:
            ...
            try:
                ...
                logger.error(
                    "netra.instrumentation.libraries.agno: failed to finalize LLM stream span on error: %s", span_err
                )
            raise
    ...
    async def _capture(
        ...
        try:
            ...
            try:
                ...
                logger.warning(
                    "netra.instrumentation.libraries.agno: failed to set async LLM response attributes: %s", e
                )
            return response
        except Exception as e:
            try:
                ...
                logger.error(
                    "netra.instrumentation.libraries.agno: failed to record error on async LLM span: %s", span_err
                )
            raise
        finally:
            try:
                ...
                logger.error("netra.instrumentation.libraries.agno: failed to end async LLM span: %s", e)
    ...
    def wrapper(
        ...
        try:
            ...
            try:
                ...
                logger.error(
                    "netra.instrumentation.libraries.agno: failed to finalize async LLM stream span on error: %s",
                    span_err,
                )
            raise
...
class AgentOSTracingMiddleware:
    ...
    async def __call__(self, scope: Dict[str, Any], receive: Any, send: Any) -> None:
        ...
        try:
            ...
            logger.warning("netra.instrumentation.libraries.agno: failed to set AgentOS span attributes: %s", e)
        ...
        try:
            ...
            logger.warning("netra.instrumentation.libraries.agno: failed to set HTTP request attributes: %s", e)
        ...
        try:
            ...
            logger.debug("netra.instrumentation.libraries.agno: failed to buffer request body: %s", e)
        ...
        try:
            ...
            logger.warning("netra.instrumentation.libraries.agno: failed to set AgentOS request input: %s", e)
        ...
        if body:
            try:
                ...
                logger.debug(
                    "netra.instrumentation.libraries.agno: request body is not valid JSON, skipping payload extraction: %s",
                    e,
                )
        if payload:
            try:
                ...
                logger.debug(
                    "netra.instrumentation.libraries.agno: failed to extract AgentOS request attributes: %s", e
                )
                            ...
                            json.dumps(
                                {
                                    ...
                                    "headers": sanitize_asgi_headers(response_headers[0]),
                                    "body": "<streaming>",
                                }
                            ),
                        )
            except Exception as e:
                logger.warning("netra.instrumentation.libraries.agno: failed to set AgentOS response attributes: %s", e)
            try:
                if error is not None:
                    span.set_status(Status(StatusCode.ERROR, str(error)))
                    span.record_exception(error)
                ...
                logger.error("netra.instrumentation.libraries.agno: failed to finalise AgentOS span: %s", e)
            try:
                if ctx_token is not None:
                    context_api.detach(ctx_token)
            except Exception as e:
                logger.debug("netra.instrumentation.libraries.agno: failed to detach AgentOS span context: %s", e)
            try:
                span.end()
            except Exception as e:
                logger.error("netra.instrumentation.libraries.agno: failed to end AgentOS span: %s", e)
...
def agentos_get_app_wrapper(tracer: Tracer) -> Callable[..., Any]:
    ...
    def wrapper(
        ...
        if not getattr(app, "_is_instrumented_by_opentelemetry", False):
            try:
                from netra.instrumentation.libraries.fastapi import FastAPIInstrumentor

                FastAPIInstrumentor.instrument_app(app)
            except Exception as e:
                logger.debug(
                    "netra.instrumentation.libraries.agno: could not apply FastAPI instrumentation to AgentOS app: %s",
                    e,
                )
        ...
        try:
            ...
            try:
                ...
                logger.debug("netra.instrumentation.libraries.agno: failed to set middleware injected flag: %s", e)
        except Exception as e:
            logger.warning("netra.instrumentation.libraries.agno: failed to inject AgentOS tracing middleware: %s", e)
