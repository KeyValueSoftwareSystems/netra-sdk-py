...
class StreamingWrapper(ObjectProxy):  # type: ignore[misc]
    ...
    def __init__(self, response: Any, span: Span) -> None:
        ...
        self._span = span
        self._body_buffer = new_body_buffer()
    ...
    def _finalize_span(self) -> None:
        ...
        try:
            ...
            logger.debug("netra.instrumentation.libraries.requests: failed to finalize streaming span: %s", e)
        finally:
            self._span.end()
...
def send_wrapper(tracer: Tracer) -> Callable[..., Any]:
    ...
    def wrapper(wrapped: Callable[..., Any], instance: Any, args: Tuple[Any, ...], kwargs: Dict[str, Any]) -> Any:
        ...
        try:
            ...
            logger.debug("netra.instrumentation.libraries.requests: failed to extract request metadata: %s", e)
            return wrapped(*args, **kwargs)
        ...
        if not is_streaming:
            with tracer.start_as_current_span(
                ...
                try:
                    ...
                    logger.error("netra.instrumentation.libraries.requests: %s", e)
                ...
                try:
                    ...
                    logger.debug("netra.instrumentation.libraries.requests: failed to process response span: %s", e)
        ...
        try:
            ...
            try:
                ...
                logger.debug("netra.instrumentation.libraries.requests: failed to set response status on span: %s", e)
