...
single generic activator (``netra.instrumentation.wiring.activation``) can apply any
of them.  Adding an instrumentation means adding a row here, an
``InstrumentSet`` member, and a trigger module in
``netra.instrumentation.wiring.triggers``.
...
CUSTOM_INSTRUMENTORS: dict[InstrumentSet, tuple[InstrumentorSpec, ...]] = {
    ...
    InstrumentSet.GROQ: (InstrumentorSpec(("groq",), "netra.instrumentation.libraries.groq", "NetraGroqInstrumentor"),),
    InstrumentSet.GOOGLE_GENERATIVEAI: (
        InstrumentorSpec(
            ("google-genai",), "netra.instrumentation.libraries.google_genai", "NetraGoogleGenAiInstrumentor"
        ),
    ),
    InstrumentSet.FASTAPI: (
        InstrumentorSpec(("fastapi",), "netra.instrumentation.libraries.fastapi", "NetraFastAPIInstrumentor"),
    ),
    ...
    InstrumentSet.WEAVIATEDB: (
        InstrumentorSpec(("weaviate-client",), "netra.instrumentation.libraries.weaviate", "WeaviateInstrumentor"),
    ),
    ...
    InstrumentSet.COHEREAI: (
        InstrumentorSpec(("cohere",), "netra.instrumentation.libraries.cohere", "CohereInstrumentor"),
    ),
    InstrumentSet.MISTRALAI: (
        InstrumentorSpec(
            ("mistralai",),
            "netra.instrumentation.libraries.mistralai",
            "MistralAiInstrumentor",
            {"exception_logger": _log_mistral_wrapper_error},
        ),
    ),
    InstrumentSet.LITELLM: (
        InstrumentorSpec(("litellm",), "netra.instrumentation.libraries.litellm", "LiteLLMInstrumentor"),
    ),
    # DSPy renamed its distribution from dspy-ai to dspy in v3.0.
    InstrumentSet.DSPY: (
        InstrumentorSpec(("dspy-ai",), "netra.instrumentation.libraries.dspy", "NetraDSPyInstrumentor"),
        InstrumentorSpec(("dspy",), "netra.instrumentation.libraries.dspy", "NetraDSPyInstrumentor"),
    ),
    InstrumentSet.OPENAI: (
        InstrumentorSpec(("openai",), "netra.instrumentation.libraries.openai", "NetraOpenAIInstrumentor"),
    ),
    InstrumentSet.DEEPGRAM: (
        InstrumentorSpec(("deepgram-sdk",), "netra.instrumentation.libraries.deepgram", "NetraDeepgramInstrumentor"),
    ),
    InstrumentSet.LIVEKIT: (
        InstrumentorSpec(("livekit-agents",), "netra.instrumentation.libraries.livekit", "NetraLiveKitInstrumentor"),
    ),
    InstrumentSet.ADK: (
        InstrumentorSpec(("google-adk",), "netra.instrumentation.libraries.google_adk", "NetraGoogleADKInstrumentor"),
    ),
    ...
    InstrumentSet.PYDANTIC_AI: (
        InstrumentorSpec(
            ("pydantic-ai",), "netra.instrumentation.libraries.pydantic_ai", "NetraPydanticAIInstrumentor"
        ),
        InstrumentorSpec(
            ("pydantic-ai-slim",),
            "netra.instrumentation.libraries.pydantic_ai_slim",
    ...
    InstrumentSet.REQUESTS: (
        InstrumentorSpec(("requests",), "netra.instrumentation.libraries.requests", "RequestsInstrumentor"),
    ),
    ...
    InstrumentSet.CEREBRAS: (
        InstrumentorSpec(
            ("cerebras_cloud_sdk",), "netra.instrumentation.libraries.cerebras", "NetraCerebrasInstrumentor"
        ),
    ),
    InstrumentSet.CARTESIA: (
        InstrumentorSpec(("cartesia",), "netra.instrumentation.libraries.cartesia", "NetraCartesiaInstrumentor"),
    ),
    InstrumentSet.ELEVENLABS: (
        InstrumentorSpec(("elevenlabs",), "netra.instrumentation.libraries.elevenlabs", "NetraElevenlabsInstrumentor"),
    ),
    InstrumentSet.CLAUDE_AGENT_SDK: (
        InstrumentorSpec(
            ("claude-agent-sdk",),
            "netra.instrumentation.libraries.claude_agent_sdk",
            "NetraClaudeAgentSDKInstrumentor",
        ),
    ),
    InstrumentSet.HERMES_AGENT: (
        InstrumentorSpec(
            ("hermes-agent",), "netra.instrumentation.libraries.hermes_agent", "NetraHermesAgentInstrumentor"
        ),
    ),
    InstrumentSet.HONCHO: (
        InstrumentorSpec(("honcho-ai",), "netra.instrumentation.libraries.honcho", "NetraHonchoInstrumentor"),
    ),
}
...
SUBPROCESS_INSTRUMENTOR = InstrumentorSpec(
    (), "netra.instrumentation.libraries.subprocess", "NetraSubprocessInstrumentor"
)
