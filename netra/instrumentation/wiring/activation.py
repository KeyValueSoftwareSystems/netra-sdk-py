...
shape is what lets ``netra.instrumentation.wiring.deferral`` defer activation to the first
...
from netra.instrumentation.wiring.selection import InstrumentationSelection
